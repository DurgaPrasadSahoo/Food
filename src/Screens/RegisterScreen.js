...
export default class RegisterScreen extends Component {
    ...
    addUserData= (values) => {
        ...
        let userData= {
          ...
          firebase.firestore().collection("users").add(userData).then(
              (res) =>{console.log("User data added Successfully", res)
              },
                    ...
                    <Content style={{ top: "10%" }}>
                        <View>
                            ...
                            <View style={{ padding: 20 }}>
                                <Formik
                                    onSubmit={values => this.addUserData(values)}
                                    ...
                                    render={props => {
                                        return (
                                            <Form style={{ height: height }}>
                                                ...
                                                <View>
                                                <View style={{ backgroundColor: "#fff", borderRadius: 10, height: "10%" }}>
                                                        <MyInput
                                                            label="First Name"
                                                            name="firstName"
                                                            type="lastName"
                                                            ...
                                                            containerStyle={{ paddingLeft: 32, bottom:10 }}
                                                            inputContainerStyle={{ paddingLeft: 20, paddingBottom:20 }}
                                                        />
                                                        <Icon style={styles.searchIcon} name="person" />
                                                    </View>
                                                    <View style={{ backgroundColor: "#fff", borderRadius: 10,top:10, height: "10%" }}>
                                                        <MyInput
                                                            label="Last Name"
                                                            name="lastName"
                                                            type="lastName"
                                                    ...
                                                    <View style={{ backgroundColor: "#fff", borderRadius: 10,top:20, height: "10%" }}>
                                                        <MyInput
                                                            label="Email"
                                                            name="email"
                                                            type="email"
                                                            ...
                                                            inputContainerStyle={{ paddingLeft: 20,bottom:10 }}
                                                        />
                                                        <Icon style={styles.searchIcon} name="person" />
                                                    </View>
                                                    <View style={{ backgroundColor: "#fff", borderRadius: 10, top: 30, height: "10%" }}>
                                                        <MyInput
                                                            label="Password"
                                                            name="password"
                                                    ...
                                                    <View style={{ position: "absolute", top: "37%", left: "80%" }}>
